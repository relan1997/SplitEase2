...
const Results = () => {
  ...
  const filteredPaymentPlan =
    results?.paymentPlan?.filter((payment) => payment.amount >= 1.0) || [];
  const showAllCleared =
    filteredPaymentPlan.length === 0 && results?.paymentPlan?.length > 0;
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-yellow-700">
                    No transaction history found for this group. Add expenses
            ...
            {showAllCleared ? (
              ...
              <>
                <div className="bg-white rounded-lg border border-gray-200">
                  <ul className="divide-y divide-gray-200">
                    {filteredPaymentPlan.map((payment, index) => (
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            <input
                              ...
                              onChange={(e) =>
                                handleTransactionSelect(index, e.target.checked)
                              }
                  ...
                  <div className="mt-4 text-center">
                    ...
                    >
                      {submitting ? (
                        ...
                        `Submit ${selectedTransactions.length} Transaction${
