...
const Groups = () => {
  ...
  const goToResults = (groupId) => {
    navigate(`/groups/${groupId}/results`);
  };

  const handleAddPeopleClick = (group, e) => {
    e.stopPropagation();
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          >
            ...
            <h1 className="text-xl font-bold text-gray-800">SplitEase</h1>
          </div>
          <nav>
            <button
              onClick={() => navigate("/")}
              ...
              {loading ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {groups.map((group) => (
                    <div
                      key={group._id}
                      className="p-4 border rounded-lg cursor-pointer transition-all hover:shadow-md border-gray-200 hover:border-emerald-200"
                    ...
                    >
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex space-x-2">
                          <button
                            onClick={(e) => handleAddPeopleClick(group, e)}
                  ...
                  <div className="border rounded-lg p-4">
                    <div className="text-center">
                      <p className="text-gray-500 mb-3">
                        No user found with username "{searchTerm}". Enter an
